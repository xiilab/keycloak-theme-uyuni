...
const LoginText = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="634" height="119" viewBox="0 0 490 110">
            <g fill="none" fillRule="evenodd" transform="translate(-82 -8)">
                <text fill="#FFF" fontFamily="Ubuntu-Light, Ubuntu" fontSize="54" fontWeight="300">
                    <tspan x="85" y="50">Welcome to Uyuni</tspan>
                </text>

                <text fill="#FFF" fontFamily="Ubuntu-Medium, Ubuntu" fontSize="14" fontWeight="400" opacity=".8">
                    <tspan x="131.962" y="95">Deep-Learning platform solution for operating, creating </tspan> <tspan x="190.58" y="115">and executing Deep-Learning projects</tspan>
                </text>
                <rect width="38" height="18" x="528" y="11" rx="2" />
                <text fill="#FFF" fontFamily="Ubuntu-Regular, Ubuntu" fontSize="14">
                    <tspan x="537" y="25">Suite</tspan>
                </text>
            </g>
        </svg>
    );
